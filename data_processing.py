"""
Taken from github.com/yewsiang/ConceptBottleneck
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', '-d', help='Where to save the new datasets', default="CUB_processed")
    parser.add_argument('--data_dir', help='Where to load the datasets', default="CUB_200_2011")
    ...
    for data, location in zip([train_data, val_data, test_data], ['train','val','test']):
